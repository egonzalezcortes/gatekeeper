...
[2026-04-05] — Step 1: PostgreSQL schema and migrations. Created 001-007 migration files, migrator.ts, rls.sql. — backend/migrations/*, backend/src/db/migrator.ts, backend/src/db/rls.sql, backend/src/db/client.ts, backend/src/index.ts
